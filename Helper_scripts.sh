...
sudo mount -t vboxsf Virtualbox_SharedFolder /share_data

function say_hello(){
	echo "Hello ..... !!!!!";
}
###############################################################################
## 	Java/Maven Related Env vars
###############################################################################
...
export JDK_HOME
export JRE_HOME
export MAVEN_HOME=/big_data/apps/maven/maven.default
...
###############################################################################
##	Java/Maven Version Switch Commands
###############################################################################
...
function switch_to_maven_3_2_5(){
	rm -f /big_data/apps/maven/maven.default;
	ln -s /big_data/apps/maven/maven_3_2_5/ /big_data/apps/maven/maven.default;
}
...
###############################################################################
PATH=$PATH:$JDK_HOME/bin:$HADOOP_PREFIX/bin:$HADOOP_PREFIX/sbin:$PIG_HOME/bin:$HIVE_HOME/bin:$SPARK_HOME/bin:$SPARK_HOME/sbin:$MAVEN_HOME/bin
